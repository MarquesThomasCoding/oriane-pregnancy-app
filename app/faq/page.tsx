      ...
      <main className="container px-4 py-6 space-y-6 max-w-6xl mx-auto">
        ...
        <section id="main-content">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-foreground text-balance">Questions fréquentes</h1>
          </div>
        ...
        <Card className="p-4 bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
          <p className="text-sm text-muted-foreground text-pretty">
            <strong className="text-foreground">Important:</strong> Ces informations sont générales et ne remplacent pas
            l'avis médical. Consultez toujours votre médecin ou sage-femme pour des conseils personnalisés.
          </p>
        </Card>
                  ...
                  {category.questions.map((item, index) => (
                    ...
                    >
                      ...
                      <AccordionContent className="px-4 pb-4">
                        <p className="text-muted-foreground text-pretty leading-relaxed">{item.a}</p>
                      </AccordionContent>
                    </AccordionItem>
                  ))}
                </Accordion>
        ...
        <Card className="p-6 bg-gradient-to-br from-tertiary/10 to-tertiary/5 border-tertiary/20">
          <h3 className="font-bold text-foreground mb-2">Vous ne trouvez pas de réponse ?</h3>
          <p className="text-sm text-muted-foreground mb-4">
            N'hésitez pas à contacter votre sage-femme ou votre médecin pour toute question concernant votre grossesse.
          </p>
        </Card>
      </main>
